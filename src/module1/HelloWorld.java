...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// Instantiate the new map with location and size
		map2 = new UnfoldingMap(this, 500, 50, 350, 500, provider);
		
		// zoom in center to my location (Cheboygan, MI or Brandon, FL)
		// Brandon, FL @27.9002274,-82.296972,13z
		// Cheboygan, MI @45.6448876,-84.5008638,13z
		map2.zoomAndPanTo(zoomLevel, new Location(45.6f, -84.5f));
